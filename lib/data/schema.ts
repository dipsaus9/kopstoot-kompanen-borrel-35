...
export const QUESTIONS: readonly QuestionField[] = [
  ...
  { key: "planSpontaneous", number: 15, label: "Kies één: Plannen / Spontaan", role: "cluster", type: "single", encoding: "binary", options: PLAN_SPONTANEOUS },
  { key: "cityNature", number: 16, label: "Kies één: Stad / Natuur", role: "cluster", type: "single", encoding: "binary", options: CITY_NATURE },
  { key: "festivalTerrace", number: 17, label: "Kies één: Festival / Terras", role: "cluster", type: "single", encoding: "binary", options: FESTIVAL_TERRACE },
  { key: "earlyBedLate", number: 18, label: "Kies één: Vroeg naar bed / We zien wel waar dit eindigt", role: "cluster", type: "single", encoding: "binary", options: EARLY_BED_LATE },
  { key: "cuisine", number: 19, label: "Kies één (keuken)", role: "cluster", type: "single", encoding: "nominal", options: CUISINE },
  { key: "morningEvening", number: 20, label: "Kies één: Ochtendmens / Avondmens", role: "cluster", type: "single", encoding: "binary", options: MORNING_EVENING },
  ...
  { key: "danceSideline", number: 27, label: "Kies één: Dansvloer / Zijlijn", role: "cluster", type: "single", encoding: "binary", options: DANCE_SIDELINE },
