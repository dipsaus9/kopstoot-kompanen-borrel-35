      ...
      {selected.length > 0 ? (
        <section aria-labelledby="compare-heading" className="flex min-w-0 flex-col gap-stack-md">
          ...
          <div
            ...
            tabIndex={0}
            className="ink-outline relative w-full min-w-0 max-w-full overflow-x-auto rounded-3xl bg-card focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 focus-visible:ring-offset-background max-md:-mx-stack-md max-md:w-auto max-md:max-w-none max-md:rounded-none max-md:border-x-0"
          >
